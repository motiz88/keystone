...
module.exports = function (keystone) {
	...
	List.prototype.fireQueryHook = require('./list/fireQueryHook');
	List.prototype.getQueryHook = require('./list/getQueryHook');
	List.prototype.hasQueryHook = require('./list/hasQueryHook');
